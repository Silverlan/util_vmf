...
bool vmf::Intersect::AABBInAABB(const glm::vec3 &minA,const glm::vec3 &maxA,const glm::vec3 &minB,const glm::vec3 &maxB)
{
...
bool vmf::Sweep::AABBWithAABB(glm::vec3 aa,glm::vec3 &ab,glm::vec3 &extA,
	glm::vec3 ba,glm::vec3 &bb,glm::vec3 &extB,
	float *entryTime,float *exitTime,glm::vec3 *normal)
{
	::vmf::AABB a(aa,extA);
	::vmf::AABB b(ba,extB);
	*entryTime = 0;

...
void vmf::PolyMesh::BuildDisplacement(
	Poly *poly,std::vector<glm::vec3> &verts,glm::vec3 &nu,glm::vec3 &nv,unsigned int w,unsigned int h,
...
void vmf::PolyMesh::BuildDisplacementTriangles(std::vector<glm::vec3> &sideVerts,unsigned int start,
